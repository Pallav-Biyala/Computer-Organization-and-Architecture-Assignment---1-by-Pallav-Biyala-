...
int main()
{
    ...
    clock_gettime(
# 50 "Matrix_multiplication.c" 3 4
                 0
# 50 "Matrix_multiplication.c"
                               , &start);
    ...
    clock_gettime(
# 63 "Matrix_multiplication.c" 3 4
                 0
# 63 "Matrix_multiplication.c"
                               , &end);
